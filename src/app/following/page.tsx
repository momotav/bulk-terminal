    ...
    return (
      <div className="min-h-screen flex flex-col bg-[var(--bg-base)]">
        <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-6">
          <div className="bg-[var(--bg-muted)] border border-[var(--border-color)] rounded-lg p-12 text-center">
    ...
    <div className="min-h-screen flex flex-col bg-[var(--bg-base)]">
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-6">
        ...
        {loading ? (
            ...
            {[...Array(3)].map((_, i) => (
              <div key={i} className="bg-[var(--bg-muted)] border border-[var(--border-color)] rounded-lg p-4 animate-pulse">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-[var(--bg-secondary-20)] rounded-full" />
                  <div className="flex-1">
                    <div className="h-4 w-32 bg-[var(--bg-secondary-20)] rounded mb-2" />
                    <div className="h-3 w-48 bg-[var(--bg-secondary-20)] rounded" />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="bg-[var(--bg-muted)] border border-[var(--border-color)] rounded-lg divide-y divide-dark-border">
            {wallets.map((w) => (
              <div
                key={w.wallet_address}
                className="flex items-center gap-4 p-4 hover:bg-[var(--bg-secondary-20)]/30 transition-colors"
              >
                {/* Avatar */}
                {w.twitter_avatar ? (
                  <img 
                ...
                <div className="flex items-center gap-2">
                  <Link
                    ...
                    prefetch={false}
                    className="p-2 hover:bg-[var(--bg-secondary-20)] rounded-lg transition-colors"
                    title="View wallet"
                  >
